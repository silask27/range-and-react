...
def build_action_features_v7(*, spot: Any, raw_context: dict[str, object]) -> dict[str, object]:
    ...
    out: dict[str, object] = {
        ...
        "board_double_paired": _bool_to_int(raw_context.get("board_double_paired")),
        "board_triple_card": _bool_to_int(raw_context.get("board_triple_card")),
        "board_4_liner": _bool_to_int(raw_context.get("board_4_liner")),
