...
def build_size_feature_dict_v2(raw_features: dict[str, object], model_kind: str) -> dict[str, object]:
    ...
    out: dict[str, object] = {
        ...
        "board_double_paired": _bool_to_int(raw_features.get("board_double_paired")),
        "board_triple_card": _bool_to_int(raw_features.get("board_triple_card")),
        "board_4_liner": _bool_to_int(raw_features.get("board_4_liner")),
