...
const sectionHeaderStyle: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "flex-start", flexWrap: "wrap", marginBottom: 16, minWidth: 0 };
...
const compactRowStyle: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap", padding: "15px 16px", borderRadius: 18, border: "1px solid var(--line)", background: "var(--surface-fill-strong)", minWidth: 0 };
...
const rowRightStyle: CSSProperties = { display: "grid", gap: 8, justifyItems: "end", textAlign: "right", minWidth: 0 };
...
const secondaryLinkStyle: CSSProperties = { padding: "10px 14px", borderRadius: 999, border: "1px solid var(--line)", background: "var(--surface-fill-strong)", color: PALETTE.cream, textDecoration: "none", fontWeight: 800, fontSize: 14, textAlign: "center" };
