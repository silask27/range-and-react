...
const filterBarStyle: CSSProperties = { display: "grid", gridTemplateColumns: "minmax(220px, 0.9fr) repeat(5, minmax(170px, 1fr))", gap: 16, alignItems: "end" };
...
const selectCaretStyle: CSSProperties = { position: "absolute", right: 14, top: "50%", transform: "translateY(-56%)", color: "var(--text-65)", pointerEvents: "none", fontSize: 22, fontWeight: 900, lineHeight: 1 };
const topGridStyle: CSSProperties = { display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", gap: 28, alignItems: "start" };
const insightGridStyle: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 16 };
