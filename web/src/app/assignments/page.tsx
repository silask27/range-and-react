...
const headerStatStyle: CSSProperties = { flex: "1 1 140px", minWidth: 0, borderRadius: 18, padding: "14px 16px", border: "1px solid var(--line)", background: "rgba(20,18,16,1)" };
...
const assignmentMetaWrapStyle: CSSProperties = { display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end", minWidth: 0 };
...
const primaryLinkStyle: CSSProperties = { padding: "11px 18px", borderRadius: 999, background: PALETTE.coral, color: PALETTE.cream, fontWeight: 800, textDecoration: "none", textAlign: "center" };
const suggestionCardStyle: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", flexWrap: "wrap", padding: "18px", borderRadius: 18, border: "1px solid var(--line)", background: "var(--surface-fill-strong)", minWidth: 0 };
...
const secondaryLinkStyle: CSSProperties = { padding: "10px 16px", borderRadius: 999, border: `1px solid ${PALETTE.coral}`, color: PALETTE.cream, textDecoration: "none", fontWeight: 800, textAlign: "center", background: PALETTE.coral };
